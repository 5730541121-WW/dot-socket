...
function init() {
	...
	localPlayer = new Player(startX, startY, roomId);
...
function onSocketConnected() {
	...
	socket.emit("new player", {x: localPlayer.getX(), y: localPlayer.getY(), roomId: localPlayer.getRoomId()});
};
...
**************************************************/
function animate() {
	update(); // update local player position
	draw();
